	...
	<div class="page-header page-header-default">
		<div class="page-header-content">
			<div class="page-title">
				<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Masterlist <?php echo $_GET['ay'] ?></span></h4>
			</div>
					...
					<?php
						if (is_array($year_list)) {
							foreach ($year_list as $list) {
								echo '
									<a href="'.base_url('DataEntry-Masterlist?ay=').''.$list->annual_year.'" class="btn btn-primary btn-xs">
										A.Y '.$list->annual_year.'
									</a>
								';
							}
						}
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h6 class="panel-title">
							<b>Data Received Masterlist <?php echo $_GET['ay'] ?></b><br>
					...
					<div class="panel-body">
						<table class="table datatable-button-init-basic" style="text-transform: uppercase;">
							...
							<tbody>
								<?php
									if (is_array($load_DateEntry)) {
										foreach ($load_DateEntry as $list) {
											if ($list->print == "") {
												$print_receive = '*';
											}
												...
												<tr>
													...
													<td style="color:teal;">
														<abbr title="Manage Data">
															<a href="DataEntry-Details?ay='.$list->year.'&id='.$list->id.'&item=masterlist">
																'.$list->doc_no.'
															</a>
														</abbr>
													</td>
